...
public class JobsPageWithFiltersTest {
    
    @Test
    public void testJobsPageWithFilters() {
        System.out.println("=== JOBS PAGE WITH FILTERS TEST ===");
        ...
        System.out.println("=== JOBS PAGE WITH FILTERS TEST COMPLETED ===");
    }
}
